...
<body>
    <nav>
        <div class="header">
            ...
            <div class="links">
                ...
                <a href="index3.php" style="color: yellow;">CONTACT US</a>
    ...
    <div class="container-1">
        <h1 class="title">Party Needs Contact Support</h1>
    ...
    <div class="container-2">
        <form action="SUBMIT">
            ...
            <label for="help">How we can help you:</label><br>
            <textarea id="help" name="help" rows="4" cols="50" required></textarea><br><br>
