<?php
    ...
    if(isset($_POST['updateSubmit'])){
        ...
        $queryUpdate = "UPDATE books SET title='$updateTitle', author_id='$updateAuthor', category_id='$updateCategory', price='$updatePrice', stock_quantity='$updateStockQuantity' WHERE title='$editTitle'";
...
<body>
        <div class="container">
            ...
            <p></p>
            <form class="" action="/bookstore/edit.php" method="post">
